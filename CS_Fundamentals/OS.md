...
- What is Memory management ?
    ...
    - Which ensures effecient allocation , deallocation and protection of memory spaces 
...
- What is virtual memory ?
    ...
    - Advantages :- 
        ...
        - Runs larger programms effeciently without using the huge physicall memory 
        
        - Improved CPU utilisation 

        - Better Isolation and security 

        - Effecient memory handling using the pagging and segmentation
...
- What is Thrashing ?
    ...
    - Solutons :- 
        - Increase the RAM 
        - Reduse the number of programs 
        - Use page replacement algo's 
